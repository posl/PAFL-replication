...
def full_imdb(word_vectors):
  ...
  save_path = get_path("data/training_data/raw_data/imdb/full_data_50K.pkl")
  full_data = {}
  full_data["x"] = x
  full_data["y"] = y
...
def divide_imdb():
  full_data = load_pickle(get_path("data/training_data/raw_data/imdb/full_data_50K.pkl"))
  data = {}
  X = []
  Y = []
