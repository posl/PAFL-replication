        ...
        for theta in [10, 50]:
          ...
          for dataset in datasets:
            for k in range(2, 12, 2):
              ...
              pred_res['ex'] = load_pickle(ExtractData.EX_PRED.format(model_type, dataset, i, k, n, theta, method))
              pred_res['rand'] = load_pickle(ExtractData.RAND_PRED.format(model_type, dataset, i, k, n, theta))
